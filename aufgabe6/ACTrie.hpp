...
struct ACNode
{
    ...
    std::vector<unsigned> needle_indices{}; ///index of needle in vec needles
    unsigned depth{};
};
...
public:
    ...
    /// Resume at the last position in the haystack until any of the patterns is found: fill @p hits with all patterns found and return true.
...
private:
    ...
    void buildTree(ACNode root, std::vector<ACNode> trie, const std::vector<std::string>& needles);
